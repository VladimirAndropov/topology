...
# Создание окна
screen = pygame.display.set_mode((WINDOW_SIZE*4, WINDOW_SIZE*3))
pygame.display.set_caption("Chess 3d V&K")



def draw_chessboard(col_int:int = 0, row_int:int = 0) -> None:
    """
...
def game(): 
    ...
    while running:
        ...
        if second_coordinate and selected_coordinate:
            move = game_field.move_figure((y1, x1), (y2, x2), похуй=True, left=True)
            if  False: # not move:
